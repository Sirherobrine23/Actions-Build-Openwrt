...
sudo apt purge -y *golang* *node* *android* *google* *mysql* *java* *openjdk* &> /home/copiler/Apt-Log.txt
...
echo "Instalando Os Pacotes Adicionais: $1"
sudo apt -y install $1 &> /home/copiler/Apt-Log.txt
